...
const translations = {
  es: {
    ...
    'contact.sendMessageDesc': 'Completa el formulario y nos pondremos en contacto contigo lo antes posible.',
    'contact.contactInfo': 'Información de contacto',
    'contact.email': 'Email',
    'contact.phone': 'Teléfono',
    'contact.location': 'Ubicación',
    'contact.schedule': 'Horario de atención',
    'contact.scheduleTime': 'Lun - Vie: 9:00 AM - 6:00 PM',
    'contact.needHelp': '¿Necesitas ayuda inmediata?',
    'contact.urgentQuestion': 'Si tienes una pregunta urgente, no dudes en llamarnos durante nuestro horario de atención.',
    'contact.callNow': 'Llamar ahora',
    'electronics.title': 'Electrónicos para Estudiantes',
    'electronics.subtitle': 'Encuentra laptops, tablets, audífonos y otros dispositivos electrónicos esenciales para tu éxito académico',
    'electronics.search': 'Buscar productos electrónicos...',
    'electronics.all': 'Todos',
    'electronics.laptops': 'Laptops',
    'electronics.tablets': 'Tablets',
    'electronics.headphones': 'Audífonos',
    'electronics.recorders': 'Grabadores',
    'electronics.calculators': 'Calculadoras',
    'electronics.accessories': 'Accesorios',
    'electronics.productsAvailable': 'Productos Disponibles',
    'electronics.averageRating': 'Calificación Promedio',
    'electronics.shipping': 'Envío',
    'electronics.freeShipping': 'Gratis en pedidos +$50',
    'electronics.outOfStock': 'Agotado',
    'electronics.addToCart': 'Agregar al Carrito',
    'electronics.noProducts': 'No se encontraron productos',
    'electronics.noProductsDesc': 'Intenta con otros términos de búsqueda o categorías diferentes',
    'electronics.clearFilters': 'Limpiar filtros',
    'electronics.needHelp': '¿Necesitas ayuda para elegir?',
    'electronics.helpDesc': 'Nuestro equipo de expertos puede ayudarte a encontrar los productos electrónicos perfectos para tus necesidades académicas.',
    'electronics.contactSpecialist': 'Contactar Especialista',
    'schools.loadingSchools': 'Cargando escuelas...',
    'schools.selectSchool': 'Selecciona tu Escuela',
    'schools.selectSchoolDesc': 'Encuentra tu escuela en nuestra lista y accede a las listas de útiles específicas para cada grado.',
    'schools.countyCovered': 'Condado Cubierto',
    'schools.school': 'Escuela',
    'schools.principal': 'Director/a',
    'schools.phone': 'Tel',
    'schools.website': 'Sitio Web',
    'schools.noSchoolsRegistered': 'No hay escuelas registradas',
    'schools.noSchoolsDesc': 'Aún no se han añadido escuelas al sistema',
    'schools.showing': 'Mostrando',
    'schools.of': 'de',
    'schools.showingSchools': 'escuelas',
    'schools.viewAllSchools': 'Ver todas las escuelas',
    'schools.clearSearch': 'Limpiar búsqueda',
    'schools.cantFindSchool': '¿No encuentras tu escuela?',
    'schools.cantFindSchoolDesc': 'Estamos constantemente añadiendo nuevas escuelas a nuestra plataforma. Contáctanos para solicitar que incluyamos tu escuela.',
    'schools.requestNewSchool': 'Solicitar Nueva Escuela',
    'hero.slide1.title': 'Bienvenido a Plan Ahead Solutions',
    'hero.slide1.subtitle': 'Encuentra las listas oficiales de tu escuela en segundos',
    'hero.slide1.button': 'Buscar mi escuela',
    'hero.slide2.title': 'Compra todo lo que necesitas sin salir de casa',
    'hero.slide2.subtitle': 'Envío rápido y devoluciones fáciles',
    'hero.slide2.button': 'Ver Packs Populares',
    'hero.slide3.title': 'Mantente organizado',
    'hero.slide3.subtitle': 'Registra tus compras y accede a tus listas cuando quieras',
    'hero.slide3.button': 'Mi perfil',
  },
  en: {
    // Navbar
    'nav.home': 'Home',
    ...
    'contact.sendMessageDesc': 'Fill out the form and we\'ll get in touch with you as soon as possible.',
    'contact.contactInfo': 'Contact Information',
    'contact.email': 'Email',
    'contact.phone': 'Phone',
    'contact.location': 'Location',
    'contact.schedule': 'Business Hours',
    'contact.scheduleTime': 'Mon - Fri: 9:00 AM - 6:00 PM',
    'contact.needHelp': 'Need immediate help?',
    'contact.urgentQuestion': 'If you have an urgent question, don\'t hesitate to call us during our business hours.',
    'contact.callNow': 'Call now',
    'electronics.title': 'Electronics for Students',
    'electronics.subtitle': 'Find laptops, tablets, headphones and other electronic devices essential for your academic success',
    'electronics.search': 'Search electronics...',
    'electronics.all': 'All',
    'electronics.laptops': 'Laptops',
    'electronics.tablets': 'Tablets',
    'electronics.headphones': 'Headphones',
    'electronics.recorders': 'Recorders',
    'electronics.calculators': 'Calculators',
    'electronics.accessories': 'Accessories',
    'electronics.productsAvailable': 'Products Available',
    'electronics.averageRating': 'Average Rating',
    'electronics.shipping': 'Shipping',
    'electronics.freeShipping': 'Free on orders $50+',
    'electronics.outOfStock': 'Out of Stock',
    'electronics.addToCart': 'Add to Cart',
    'electronics.noProducts': 'No products found',
    'electronics.noProductsDesc': 'Try different search terms or categories',
    'electronics.clearFilters': 'Clear filters',
    'electronics.needHelp': 'Need help choosing?',
    'electronics.helpDesc': 'Our expert team can help you find the perfect electronic products for your academic needs.',
    'electronics.contactSpecialist': 'Contact Specialist',
    'schools.loadingSchools': 'Loading schools...',
    'schools.selectSchool': 'Select Your School',
    'schools.selectSchoolDesc': 'Find your school in our list and access specific supply lists for each grade.',
    'schools.countyCovered': 'County Covered',
    'schools.school': 'School',
    'schools.principal': 'Principal',
    'schools.phone': 'Phone',
    'schools.website': 'Website',
    'schools.noSchoolsRegistered': 'No schools registered',
    'schools.noSchoolsDesc': 'No schools have been added to the system yet',
    'schools.showing': 'Showing',
    'schools.of': 'of',
    'schools.showingSchools': 'schools',
    'schools.viewAllSchools': 'View all schools',
    'schools.clearSearch': 'Clear search',
    'schools.cantFindSchool': 'Can\'t find your school?',
    'schools.cantFindSchoolDesc': 'We\'re constantly adding new schools to our platform. Contact us to request that we include your school.',
    'schools.requestNewSchool': 'Request New School',
    'hero.slide1.title': 'Welcome to Plan Ahead Solutions',
    'hero.slide1.subtitle': 'Find your school\'s official lists in seconds',
    'hero.slide1.button': 'Find my school',
    'hero.slide2.title': 'Buy everything you need without leaving home',
    'hero.slide2.subtitle': 'Fast shipping and easy returns',
    'hero.slide2.button': 'View Popular Packs',
    'hero.slide3.title': 'Stay organized',
    'hero.slide3.subtitle': 'Track your purchases and access your lists anytime',
    'hero.slide3.button': 'My profile',
  }
};
